...
typedef BOOL (*PFN_BLE_INITIALIZE)(INOUT VOID **pInitData, IN VOID* );
...
typedef VOID (*PFN_BLE_WAKEUP)();
typedef VOID (*PFN_BLE_SLEEP)();
typedef VOID (*PFN_BLE_ENABLECLOCK)();
typedef VOID (*PFN_BLE_DISABLECLOCK)();
typedef VOID (*PFN_BLE_RESET)();
typedef VOID (*PFN_BLE_PRINTREGISTERS)();
