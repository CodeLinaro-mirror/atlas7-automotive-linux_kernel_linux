...
static char *std_clk_io_parents[] = {
	"io",
};
...
static char *std_clk_dsp_parents[] = {
	"dsp",
};
...
static char *std_clk_sys_parents[] = {
	"sys",
};
...
static char *std_clk_usb_parents[] = {
	"usb_pll",
};
...
void __init sirfsoc_marco_of_clk_init(void)
{
	struct clk *clk;
