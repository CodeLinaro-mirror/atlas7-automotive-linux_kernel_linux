...
#define AUDIO_IC_CODEC_PWR			(0x0000)
#define AUDIO_IC_CODEC_CTRL0			(0x0004)
#define AUDIO_IC_CODEC_CTRL1			(0x0008)
#define AUDIO_IC_CODEC_CTRL2			(0x000C)
#define AUDIO_IC_CODEC_CTRL3			(0x0010)

#define AUDIO_CTRL_IC_CODEC_TX_CTRL		(0x0014)
#define AUDIO_CTRL_IC_CODEC_RX_CTRL		(0x0018)

#define AUDIO_CTRL_IC_TXFIFO_OP			(0x001C)
#define AUDIO_CTRL_IC_TXFIFO_LEV_CHK		(0x0020)
#define AUDIO_CTRL_IC_TXFIFO_STS		(0x0024)
#define AUDIO_CTRL_IC_TXFIFO_INT		(0x0028)
#define AUDIO_CTRL_IC_TXFIFO_INT_MSK		(0x002C)

#define AUDIO_CTRL_IC_RXFIFO_OP			(0x0030)
#define AUDIO_CTRL_IC_RXFIFO_LEV_CHK		(0x0034)
#define AUDIO_CTRL_IC_RXFIFO_STS		(0x0038)
#define AUDIO_CTRL_IC_RXFIFO_INT		(0x003C)
#define AUDIO_CTRL_IC_RXFIFO_INT_MSK		(0x0040)
